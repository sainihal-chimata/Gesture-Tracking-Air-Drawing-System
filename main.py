...
# Core tracking instances initialized once
...
# Thread-safe global app state container
class AppState:
    canvas = None
    prev_x = None
    prev_y = None
...
# Sync UI changes directly to the safe AppState object
...
def video_frame_callback(frame):
    ...
    # Handle canvas initialization safely without session_state
